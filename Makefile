...
EXECUTE_OBJECTS = build/jobs.o build/builtin.o build/execute.o build/prepare.o build/redirect.o $(PARSER_OBJECTS) build/state.o build/expand.o build/arithmetic.o $(FIELDS_OBJECTS)
