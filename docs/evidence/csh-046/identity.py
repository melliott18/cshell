...
identity={'recorded_utc':datetime.datetime.now(datetime.timezone.utc).isoformat(),
 'source_revision':'5e77577e892192567c091d0c20658ce4f01f6327',
 'source_note':'Normal runs preceded the source commit on identical source/test bytes. Source digest covers Makefile, src, include and tests, excluding Python caches. Validation records and CI-only changes are outside that digest.',
