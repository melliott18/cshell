...
external environment and PATH probes through the literal adapter;
...
records native, Docker, and sanitizer results. Full expansion, builtins/functions,
and public-runtime integration remain open; these are module contracts.
