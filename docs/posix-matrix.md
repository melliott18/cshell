...
variable builtins, startup initialization, and full runtime option behavior
remain open in their owning tickets.
...
below; full builtins/functions and requirement-family verification remain open.
