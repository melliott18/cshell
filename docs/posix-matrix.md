...
| <a id="env-002"></a>ENV-002 | Maintain positional parameters and `@`, `*`, `#`, `?`, `-`, `$`, `!`, `0`, including quoting and subshell behavior. | [2.5.1–2.5.2](https://pubs.opengroup.org/onlinepubs/9799919799/utilities/V3_chap02.html#tag_19_05_01) | required; context-specific unspecified `@` cases labeled in fixtures | [CSH-022](tickets/CSH-022-shell-state-storage.md), [CSH-024](tickets/CSH-024-value-expansions.md) | `state/positional-special` | missing; [state API evidence](#csh-022-api-evidence) covers copied parameters and status/PID/background/options metadata; expansion, quoting, and runtime subshell behavior remain open |
