...
| `src/execute.c` / `include/cshell/execute.h` | Owned prepared-command boundary, bounded literal AST adapter, command lookup, owned child execution, and parent builtin dispatch |
...
assignment lifetime. CSH-029 supplies [state builtins](state-builtins.md).
