...
`make test` includes independent input/invocation, lexer, shell-state, and
value-expansion API checks. Its default behavioral suite records the current prototype's stdin
...
src/quote.c      Reusable dollar-single-quote escape decoding
